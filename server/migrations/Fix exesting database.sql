...
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS bankTransfers TEXT;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS sourceInvoiceId VARCHAR(36);
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS relatedInvoiceIds JSON;
...
ALTER TABLE journal_entries ADD COLUMN IF NOT EXISTS sourceInvoiceId VARCHAR(36);
...
-- ============================================================
-- 20. TREASURY AND BANKING TABLES (Missing from older versions)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS cheques (
    ...
    INDEX idx_cheques_type (type),
    INDEX idx_cheques_dueDate (dueDate),
    INDEX idx_cheques_partnerId (partnerId)
);
...
CREATE TABLE IF NOT EXISTS account_transactions (
    ...
    invoiceId VARCHAR(36),
    createdBy VARCHAR(255),
    INDEX idx_account_transactions_date (date),
    INDEX idx_account_transactions_partnerId (partnerId),
    INDEX idx_account_transactions_invoiceId (invoiceId)
);

-- Ensure columns exist if table already existed
ALTER TABLE cheques ADD COLUMN IF NOT EXISTS transactionId VARCHAR(36);
ALTER TABLE banks ADD COLUMN IF NOT EXISTS accountId VARCHAR(36);
...
CREATE TABLE IF NOT EXISTS vehicle_inventory (
    ...
    avgDailySales DECIMAL(15,3) DEFAULT 0,
    UNIQUE KEY unique_vehicle_product (vehicleId, productId),
...
CREATE TABLE IF NOT EXISTS vehicle_operation_items (
    ...
    INDEX idx_vehicle_op_items_product (productId)
);
...
CREATE TABLE IF NOT EXISTS vehicle_customer_visits (
    ...
    debtCollected DECIMAL(15,2) DEFAULT 0,
    createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS vehicle_returns (
    ...
    notes TEXT,
    createdBy VARCHAR(100),
    returnInvoiceId VARCHAR(36),
    creditNoteId VARCHAR(36),
...
CREATE TABLE IF NOT EXISTS vehicle_return_items (
    ...
    totalPrice DECIMAL(15,2) DEFAULT 0,
    reason TEXT,
    returnedToWarehouse BOOLEAN DEFAULT FALSE,
    warehouseId VARCHAR(36),
...
CREATE TABLE IF NOT EXISTS vehicle_settlements (
    ...
    totalReturns DECIMAL(15,2) DEFAULT 0,
    returnCount INT DEFAULT 0,
    cashReturns DECIMAL(15,2) DEFAULT 0,
    openingInventoryValue DECIMAL(15,2) DEFAULT 0,
    loadedValue DECIMAL(15,2) DEFAULT 0,
    unloadedValue DECIMAL(15,2) DEFAULT 0,
    closingInventoryValue DECIMAL(15,2) DEFAULT 0,
    expectedInventoryValue DECIMAL(15,2) DEFAULT 0,
    inventoryDifference DECIMAL(15,2) DEFAULT 0,
    plannedVisits INT DEFAULT 0,
    completedVisits INT DEFAULT 0,
    successfulVisits INT DEFAULT 0,
    openingCash DECIMAL(15,2) DEFAULT 0,
    ...
    actualCash DECIMAL(15,2) DEFAULT 0,
    cashDifference DECIMAL(15,2) DEFAULT 0,
    debtCollectedCash DECIMAL(15,2) DEFAULT 0,
    debtCollectedCheques DECIMAL(15,2) DEFAULT 0,
    totalDebtCollected DECIMAL(15,2) DEFAULT 0,
    chequesCollectedValue DECIMAL(15,2) DEFAULT 0,
    totalExpenses DECIMAL(15,2) DEFAULT 0,
    bankTransferAmount DECIMAL(15,2) DEFAULT 0,
    bankTransferReference VARCHAR(100),
    status ENUM('DRAFT', 'SUBMITTED', 'APPROVED', 'DISPUTED') DEFAULT 'DRAFT',
...
CREATE TABLE IF NOT EXISTS settlement_expenses (
    ...
    category ENUM('FUEL', 'FOOD', 'DELIVERY', 'PARKING', 'MAINTENANCE', 'OTHER') NOT NULL DEFAULT 'OTHER',
    description VARCHAR(500),
    amount DECIMAL(15,2) NOT NULL DEFAULT 0,
    receiptNumber VARCHAR(100),
    createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    INDEX idx_settlement_expenses_settlement (settlementId)
);

CREATE TABLE IF NOT EXISTS settlement_cheques (
    id VARCHAR(36) PRIMARY KEY,
    settlementId VARCHAR(36) NOT NULL,
    ...
    createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    INDEX idx_settlement_cheques_settlement (settlementId)
);
...
CREATE TABLE IF NOT EXISTS vehicle_targets (
    ...
    periodEnd DATE NOT NULL,
    achievedValue DECIMAL(15,2) DEFAULT 0,
    achievementPercentage DECIMAL(5,2) DEFAULT 0,
    isActive BOOLEAN DEFAULT TRUE,
    notes TEXT,
    createdBy VARCHAR(100),
    createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS salesman_targets (
    ...
    createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    INDEX idx_salesman_target_salesman (salesmanId),
    INDEX idx_salesman_target_product (productId),
    INDEX idx_salesman_target_period (periodStart, periodEnd)
);
...
-- ============================================================
-- 23_B. SAFETY: ENSURE VAN SALES COLUMNS EXIST (For existing incomplete tables)
-- ============================================================

ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS nextMaintenanceDate DATE;
ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS nextMaintenanceMileage INT;
ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS plateNumber VARCHAR(50) NOT NULL;

ALTER TABLE vehicle_inventory ADD COLUMN IF NOT EXISTS minQuantity DECIMAL(15,3) DEFAULT 0;
ALTER TABLE vehicle_inventory ADD COLUMN IF NOT EXISTS avgDailySales DECIMAL(15,3) DEFAULT 0;

ALTER TABLE vehicle_operations ADD COLUMN IF NOT EXISTS totalValue DECIMAL(15,2) DEFAULT 0;
ALTER TABLE vehicle_operations ADD COLUMN IF NOT EXISTS itemCount INT DEFAULT 0;

ALTER TABLE vehicle_customer_visits ADD COLUMN IF NOT EXISTS returnId VARCHAR(36);
ALTER TABLE vehicle_customer_visits ADD COLUMN IF NOT EXISTS returnAmount DECIMAL(15,2) DEFAULT 0;
ALTER TABLE vehicle_customer_visits ADD COLUMN IF NOT EXISTS debtCollected DECIMAL(15,2) DEFAULT 0;

ALTER TABLE vehicle_settlements ADD COLUMN IF NOT EXISTS cashReturns DECIMAL(15,2) DEFAULT 0;
ALTER TABLE vehicle_settlements ADD COLUMN IF NOT EXISTS expectedInventoryValue DECIMAL(15,2) DEFAULT 0;
ALTER TABLE vehicle_settlements ADD COLUMN IF NOT EXISTS inventoryDifference DECIMAL(15,2) DEFAULT 0;
ALTER TABLE vehicle_settlements ADD COLUMN IF NOT EXISTS openingCash DECIMAL(15,2) DEFAULT 0;
ALTER TABLE vehicle_settlements ADD COLUMN IF NOT EXISTS debtCollectedCash DECIMAL(15,2) DEFAULT 0;
ALTER TABLE vehicle_settlements ADD COLUMN IF NOT EXISTS debtCollectedCheques DECIMAL(15,2) DEFAULT 0;
ALTER TABLE vehicle_settlements ADD COLUMN IF NOT EXISTS totalDebtCollected DECIMAL(15,2) DEFAULT 0;
ALTER TABLE vehicle_settlements ADD COLUMN IF NOT EXISTS chequesCollectedValue DECIMAL(15,2) DEFAULT 0;
...
ALTER TABLE vehicle_settlements ADD COLUMN IF NOT EXISTS journalId VARCHAR(36);

ALTER TABLE vehicle_targets ADD COLUMN IF NOT EXISTS achievementPercentage DECIMAL(5,2) DEFAULT 0;
