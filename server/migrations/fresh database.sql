-- ============================================================
-- DAFTRIX ERP - COMPLETE DATABASE SCHEMA
-- Version: 1.0.0
-- Date: 2026-02-05
-- Description: Run this script on a fresh MariaDB/MySQL database
--              to create all required tables for the ERP system.
-- ============================================================
...
CREATE TABLE IF NOT EXISTS invoices (
    ...
    referenceInvoiceId VARCHAR(36),
    paymentBreakdown TEXT,
    priceListId VARCHAR(36),
    posShiftId VARCHAR(36),
    isPOSSale BOOLEAN DEFAULT FALSE,
    bankTransfers JSON,
    sourceInvoiceId VARCHAR(36),
    relatedInvoiceIds JSON,
    ...
    INDEX idx_invoices_posted (posted),
    INDEX idx_invoices_warehouseId (warehouseId),
    INDEX idx_invoices_referenceInvoiceId (referenceInvoiceId)
);
...
CREATE TABLE IF NOT EXISTS invoice_lines (
    ...
    unitId VARCHAR(36),
    unitName VARCHAR(50),
    conversionFactor DECIMAL(15,4) DEFAULT 1,
    baseQuantity DECIMAL(15,3),
    warehouseId VARCHAR(36),
    serials JSON,
...
-- Deleted Invoices Table (Audit Trail)
...
CREATE TABLE IF NOT EXISTS journal_entries (
    ...
    INDEX idx_journal_entries_referenceId (referenceId)
);
...
CREATE TABLE IF NOT EXISTS journal_lines (
    ...
    INDEX idx_journal_lines_accountId (accountId),
    INDEX idx_journal_lines_journalId (journalId)
);

-- Account Transactions Table (Partner payment transactions)
...
CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    description TEXT,
    details TEXT,
    INDEX idx_audit_logs_date (date),
...
CREATE TABLE IF NOT EXISTS leave_balances (
    ...
    remainingDays DECIMAL(5,2) DEFAULT 0,
    year INT NOT NULL,
    UNIQUE KEY unique_emp_leave_year (employeeId, leaveTypeId, year)
);
...
-- ============================================================
-- (Outdated Van Sales Module removed - see end of file)
...
INSERT IGNORE INTO users (id, name, email, username, password, role, status, isHidden) VALUES 
('admin-user-001', 'المدير العام', 'admin@example.com', 'admin', '$2b$10$YourHashedPasswordHere', 'مدير', 'ACTIVE', FALSE);
